      ...
      <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <div className="section-container">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-3xl sm:text-4xl font-bold mb-2">Welcome back{user?.first_name ? `, ${user.first_name}` : ''}</h1>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="space-y-2">
                  <Button 
                    className="w-full justify-start gap-2 bg-primary/20 text-primary hover:bg-primary/30"
                    onClick={() => router.push('/#modules')}
                  >
